...
# command="python -m ric.main_ric --config-name $1 tasks.eval.task_name=lm-eval tasks.eval.search=true evaluation.data.eval_data=/weka_data/xinxil/private-retrieval-lm/eval_datasets/retrieval_v3_q.jsonl"
...
gantry run \
    ...
    --env-secret HF_TOKEN=XINXIL_HF_TOKEN \
